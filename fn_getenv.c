 ...
 * @environ_copy: Pointer to the copy of the environment variable.
 * @environ_length: Length of the environment variable.
 * Return: Double pointer to the copy of the environment variable.
 */
