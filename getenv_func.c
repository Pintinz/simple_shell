...
/**
 * copy_env - a function that copies an environment variable
 * @environ_copy: environment variable to copy
 * @environ_length: environment variable lenth
 * Return: it returns a double pointer
 */
